const RESPONSES = {
  ...
  'ta-IN': {
    ...
    show_substitution: (train_name, standby_name, delay, station) => 
      standby_name 
        ? `கவனத்திற்கு: ${train_name || 'ரயில்'} ${delay || '45'} நிமிடங்கள் தாமதமாகிறது. சிரமத்திற்கு வருந்துகிறோம். நிவாரண சிறப்பு ரயில் ${standby_name} சரியான நேரத்தில் இயக்க ${station || 'நிலையத்திலிருந்து'} புறப்படுகிறது.`
